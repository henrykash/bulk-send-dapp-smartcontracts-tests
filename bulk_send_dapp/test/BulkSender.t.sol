...
contract ContractTest is Test {
    ...
    address public MUFASA = 0x210f4F7a092CCdc3487B8dAB8e317A6E29aeA720;
    ...
    function testbatchTransfer() public {
        ...
        token.mintTo(address(bulkSender), 1000000);

        //assert that the balance of the bulkSender is 1000 after transfer od tokens to it
        assertEq(token.balanceOf(address(bulkSender)), 1000000);
